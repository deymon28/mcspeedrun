...
Current plugin version: `26.1.2-3.0.0-ALPHA`.
...
```text
speedrun/build/libs/speedrun-26.1.2-3.0.0-ALPHA.jar
```

## Install

1. Build the plugin jar.
2. Copy `speedrun-26.1.2-3.0.0-ALPHA.jar` into the server `plugins/` folder.
